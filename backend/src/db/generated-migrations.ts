...
CREATE UNIQUE INDEX IF NOT EXISTS \`users_username_unique\` ON \`users\` (\`username\`);`
  ...
  {
    name: "0001_familiar_prowler.sql",
    sql: `PRAGMA foreign_keys=OFF;
--> statement-breakpoint
CREATE TABLE IF NOT EXISTS \`__new_agent_metrics_24h\` (
	\`id\` integer PRIMARY KEY AUTOINCREMENT NOT NULL,
	\`agent_id\` integer NOT NULL,
	\`timestamp\` text DEFAULT 'CURRENT_TIMESTAMP',
	\`cpu_usage\` real,
...
--> statement-breakpoint
DROP TABLE \`agent_metrics_24h\`;
--> statement-breakpoint
ALTER TABLE \`__new_agent_metrics_24h\` RENAME TO \`agent_metrics_24h\`;
--> statement-breakpoint
PRAGMA foreign_keys=ON;
--> statement-breakpoint
CREATE TABLE IF NOT EXISTS \`__new_agents\` (
	\`id\` integer PRIMARY KEY AUTOINCREMENT NOT NULL,
	\`name\` text NOT NULL,
	\`token\` text NOT NULL,
	\`created_by\` integer NOT NULL,
...
--> statement-breakpoint
INSERT INTO \`__new_agents\`("id", "name", "token", "created_by", "status", "created_at", "updated_at", "hostname", "ip_addresses", "os", "version", "keepalive") SELECT "id", "name", "token", "created_by", "status", "created_at", "updated_at", "hostname", "ip_addresses", "os", "version", "keepalive" FROM \`agents\`;
--> statement-breakpoint
DROP TABLE \`agents\`;
--> statement-breakpoint
...
CREATE UNIQUE INDEX IF NOT EXISTS \`agents_token_unique\` ON \`agents\` (\`token\`);
--> statement-breakpoint
CREATE TABLE IF NOT EXISTS \`__new_monitor_daily_stats\` (
	\`id\` integer PRIMARY KEY AUTOINCREMENT NOT NULL,
	\`monitor_id\` integer NOT NULL,
	\`date\` text NOT NULL,
	\`total_checks\` integer DEFAULT 0 NOT NULL,
...
--> statement-breakpoint
INSERT INTO \`__new_monitor_daily_stats\`("id", "monitor_id", "date", "total_checks", "up_checks", "down_checks", "avg_response_time", "min_response_time", "max_response_time", "availability", "created_at") SELECT "id", "monitor_id", "date", "total_checks", "up_checks", "down_checks", "avg_response_time", "min_response_time", "max_response_time", "availability", "created_at" FROM \`monitor_daily_stats\`;
--> statement-breakpoint
DROP TABLE \`monitor_daily_stats\`;
--> statement-breakpoint
ALTER TABLE \`__new_monitor_daily_stats\` RENAME TO \`monitor_daily_stats\`;
--> statement-breakpoint
CREATE TABLE IF NOT EXISTS \`__new_monitor_status_history_24h\` (
	\`id\` integer PRIMARY KEY AUTOINCREMENT NOT NULL,
	\`monitor_id\` integer NOT NULL,
	\`status\` text NOT NULL,
	\`timestamp\` text DEFAULT 'CURRENT_TIMESTAMP',
...
--> statement-breakpoint
INSERT INTO \`__new_monitor_status_history_24h\`("id", "monitor_id", "status", "timestamp", "response_time", "status_code", "error") SELECT "id", "monitor_id", "status", "timestamp", "response_time", "status_code", "error" FROM \`monitor_status_history_24h\`;
--> statement-breakpoint
DROP TABLE \`monitor_status_history_24h\`;
--> statement-breakpoint
ALTER TABLE \`__new_monitor_status_history_24h\` RENAME TO \`monitor_status_history_24h\`;
--> statement-breakpoint
CREATE TABLE IF NOT EXISTS \`__new_monitors\` (
	\`id\` integer PRIMARY KEY AUTOINCREMENT NOT NULL,
	\`name\` text NOT NULL,
	\`url\` text NOT NULL,
	\`method\` text NOT NULL,
...
--> statement-breakpoint
INSERT INTO \`__new_notification_channels\`("id", "name", "type", "config", "enabled", "created_by", "created_at", "updated_at") SELECT "id", "name", "type", "config", "enabled", "created_by", "created_at", "updated_at" FROM \`notification_channels\`;
--> statement-breakpoint
DROP TABLE \`notification_channels\`;
--> statement-breakpoint
ALTER TABLE \`__new_notification_channels\` RENAME TO \`notification_channels\`;
--> statement-breakpoint
CREATE TABLE IF NOT EXISTS \`__new_notification_history\` (
	\`id\` integer PRIMARY KEY AUTOINCREMENT NOT NULL,
	\`type\` text NOT NULL,
	\`target_id\` integer,
	\`channel_id\` integer NOT NULL,
...
--> statement-breakpoint
INSERT INTO \`__new_notification_history\`("id", "type", "target_id", "channel_id", "template_id", "status", "content", "error", "sent_at") SELECT "id", "type", "target_id", "channel_id", "template_id", "status", "content", "error", "sent_at" FROM \`notification_history\`;
--> statement-breakpoint
DROP TABLE \`notification_history\`;
--> statement-breakpoint
ALTER TABLE \`__new_notification_history\` RENAME TO \`notification_history\`;
--> statement-breakpoint
CREATE TABLE IF NOT EXISTS \`__new_notification_settings\` (
	\`id\` integer PRIMARY KEY AUTOINCREMENT NOT NULL,
	\`user_id\` integer NOT NULL,
	\`target_type\` text DEFAULT 'global' NOT NULL,
	\`target_id\` integer,
...
--> statement-breakpoint
ALTER TABLE \`__new_notification_settings\` RENAME TO \`notification_settings\`;
--> statement-breakpoint
CREATE TABLE IF NOT EXISTS \`__new_notification_templates\` (
	\`id\` integer PRIMARY KEY AUTOINCREMENT NOT NULL,
	\`name\` text NOT NULL,
	\`type\` text NOT NULL,
	\`subject\` text NOT NULL,
...
--> statement-breakpoint
INSERT INTO \`__new_notification_templates\`("id", "name", "type", "subject", "content", "is_default", "created_by", "created_at", "updated_at") SELECT "id", "name", "type", "subject", "content", "is_default", "created_by", "created_at", "updated_at" FROM \`notification_templates\`;
--> statement-breakpoint
DROP TABLE \`notification_templates\`;
--> statement-breakpoint
ALTER TABLE \`__new_notification_templates\` RENAME TO \`notification_templates\`;
--> statement-breakpoint
CREATE TABLE IF NOT EXISTS \`__new_status_page_config\` (
	\`id\` integer PRIMARY KEY AUTOINCREMENT NOT NULL,
	\`user_id\` integer NOT NULL,
	\`title\` text DEFAULT '系统状态' NOT NULL,
	\`description\` text DEFAULT '系统当前运行状态',
...
--> statement-breakpoint
INSERT INTO \`__new_status_page_config\`("id", "user_id", "title", "description", "logo_url", "custom_css", "created_at", "updated_at") SELECT "id", "user_id", "title", "description", "logo_url", "custom_css", "created_at", "updated_at" FROM \`status_page_config\`;
--> statement-breakpoint
DROP TABLE \`status_page_config\`;
--> statement-breakpoint

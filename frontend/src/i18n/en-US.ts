const enUS = {
  translation: {
    ...
    'home.features.alerts.desc':
      'Notify you promptly when monitoring anomalies occur',
    'home.features.dashboard': 'Visual Dashboard',
    'home.features.dashboard.desc':
      'Intuitive display of monitoring data and statistics',
    ...
    // Add Agent Page
    'agent.add.note':
      'The agent will be automatically added to the system after running the installation command, no manual creation required',
    ...
    'agent.add.serverAddressHelp':
      'Ensure this address is accessible from the client server',
    'agent.add.registrationToken': 'Registration Token',
    'agent.add.generatingToken': 'Generating Token...',
    'agent.add.tokenHelp':
      'This token will be used by your agent to register with the server, the token will only be displayed once, please keep it safe',
    ...
    'agent.add.step1Help':
      'This command will download the latest version of the agent binary file from Cloudflare R2 storage and set it as executable',
    'agent.add.step2': 'Step 2: Register and start the agent',
    'agent.add.step2Help':
      'This command will start the agent and automatically register it to the server using the generated token. The parameter interval specifies the reporting interval (seconds)',
    'agent.add.optionalSetup':
      '(Optional) Set up the agent as a system service',
    'agent.add.optionalSetupHelp':
      'On Linux/Unix systems, you can use the following command to create a system service',
    ...
    'users.allowRegistrationHelp':
      'If enabled, the login page will show a registration button.',
    ...
    'statusPageConfig.publicUrlHelp':
      'This URL can be shared publicly, no login required',
    'statusPageConfig.selectionNote':
      'Note: If you do not select any API services or agents, the corresponding sections will not be displayed on the status page.',
    ...
    'statusPageConfig.configFromProperty':
      'Status page configuration fetched from config property:',
    'statusPageConfig.tryingDirectResponse':
      'API response seems to directly contain configuration data, attempting to use directly',
    ...
    'statusPageConfig.noValidConfig':
      'No valid status page configuration received or configuration is empty',
    ...
    'statusPageConfig.configLoaded':
      'Status page configuration loaded, validating monitor selection status:',
    ...
    'notifications.description':
      'Configure system notification settings, including API and agent notifications.',
    ...
    'notifications.channels.description':
      'Configure different notification channels to receive alerts about monitoring and agents.',
    ...
    'notifications.channels.tabDescription':
      'Configure and manage system notification channels, you can add multiple types of notification methods.',
    ...
    'notifications.specificMonitors.description':
      'Configure notification settings for specific API monitors, these settings will override global notification settings',
    'notifications.specificAgents.description':
      'Configure notification settings for specific agents, these settings will override global notification settings',
    ...
    'notifications.templates.comingSoon':
      'Template feature coming soon, stay tuned!',
    'notifications.templates.description':
      'Notification templates are used to customize the format of notification content',
    ...
    'notifications.templates.tabDescription':
      'Customize notification templates for different scenarios, edit message content and format as needed.',
    ...
    'notifications.globalSettings.description':
      'Configure global notification settings, including notification channels, monitor settings, and message templates. These settings will apply to all monitors and agents unless overridden by specific configurations.',
    ...
    'notifications.events.onDownOnly':
      'Send notification only when service goes down',
    ...
    'notifications.templates.deleteConfirmMessage':
